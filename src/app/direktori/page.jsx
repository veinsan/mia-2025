...
// =============================
// DATA UMKM (sinkron sama topResto)
// =============================
const UMKM_DATA = [
  { id: 1, name: "Warung Paijo", category: "makanan", img: "/assets/resto/resto1.webp", short: "Nasi goreng & lauk rumahan" },
  { id: 2, name: "Kedai Kopi Tamgan", category: "minuman", img: "/assets/resto/resto2.webp", short: "Kopi, susu, cemilan manis" },
  { id: 3, name: "Bebek Stallone", category: "makanan", img: "/assets/resto/resto3.jpg", short: "Bebek goreng sambal korek khas" },
  { id: 4, name: "Pasar Cemilan GN", category: "cemilan", img: "/assets/resto/resto4.webp", short: "Snack lokal dan manis-manis" },
  { id: 5, name: "Kantin Kampus", category: "makanan", img: "/assets/resto/resto5.webp", short: "Tempat makan murah meriah mahasiswa" },
  { id: 6, name: "Es Cendol Si Manis", category: "minuman", img: "/assets/resto/resto6.webp", short: "Es cendol dan es campur legendaris" },
  { id: 7, name: "Roti Abon Gulung", category: "cemilan", img: "/assets/resto/resto7.webp", short: "Roti gulung abon klasik" },
  { id: 8, name: "Bakso Pak Datuak", category: "makanan", img: "/assets/resto/resto8.webp", short: "Bakso pedas porsi jumbo" },
  { id: 9, name: "Ayam Geprek Cuan", category: "makanan", img: "/assets/resto/resto9.webp", short: "Ayam geprek sambal matah" },
  { id: 10, name: "Nasi Jinggo Kang Boy", category: "makanan", img: "/assets/resto/resto10.webp", short: "Nasi jinggo khas Bali di GN" },
];
...
export default function DirektoriPage() {
  ...
  const mainGrid = filtered.slice(0, 6);
    ...
    <main className="bg-[linear-gradient(180deg,#FFF3E0,white)]">
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            variants={heroItem}
            className="bg-gradient-to-r from-[#FFF3E0] via-[#FFEFD8] to-[#FFFDF8] rounded-2xl p-8 md:p-12 shadow-[0_12px_40px_rgba(232,117,36,0.06)]"
          >
            <div className="text-center max-w-3xl mx-auto">
              <motion.h1
                variants={heroItem}
                className="text-3xl md:text-4xl lg:text-5xl font-heading font-extrabold text-[#4A1E0E] leading-tight"
              >
                Temukan UMKM Kuliner Favoritmu di{" "}
                <span className="text-primary">Gelap Nyawang</span>
              </motion.h1>

              <motion.p variants={heroItem} className="mt-3 text-[#4A1E0E]/80">
                Dukung usaha lokal — cari tempat makan, minum, dan cemilan terdekat.
              </motion.p>
                ...
                <div className="mx-auto max-w-2xl">
                  <label className="relative block">
                    ...
                    <input
                      ...
                      placeholder="Cari UMKM, contoh: Paijo, Kopi, Cendol..."
